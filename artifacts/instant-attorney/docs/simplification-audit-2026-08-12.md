<!--
  HISTORICAL SOURCE — not a current to-do list.
  Landed in Phase 0 hygiene so CONSOLIDATION.md's citation is in-tree.
-->

> **Status:** Historical source for `CONSOLIDATION.md`, adopted critically.
> Consolidation chunks 0–7 are done on `main` as of 2026-08-13 (`8efb6ab`).
> What is true today is `ARCHITECTURE.md`. What is still deferred, and where
> this audit was wrong, is `CONSOLIDATION.md`. Do not implement from this file.
