...
1. **Retention — confirm the schedule.** Document 7 sets a 5-year default and category exceptions; confirm the periods, the pre-destruction notice/export mechanism, and which records must be kept longer. **Engineering must replace the 30-day auto-deletion to match before launch.**
