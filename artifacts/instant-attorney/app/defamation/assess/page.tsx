                ...
                <>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
                    {a.relevant_instruments.map((key) => {
                      ...
                      if (!inst) return null;
                      return (
                        <Link key={key} href={wizardHref(inst.wizard_type, inst.label)} style={{ fontSize: 13.5, fontWeight: 500, color: navy, background: gold, padding: "9px 14px", borderRadius: 8, textDecoration: "none" }}>
                          {inst.label} →
                        </Link>
                      );
                    })}
