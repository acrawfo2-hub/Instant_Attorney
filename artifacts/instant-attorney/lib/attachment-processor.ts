...
If this is a PROPERTY LIEN / FORECLOSURE / TITLE document (mechanic's or materialman's lien affidavit, notice of lien, deed of trust, notice of default, notice of sale / trustee's sale, abstract of judgment, property tax delinquency notice, title commitment or title report, payoff or reinstatement letter, or lien release), be especially precise in EXTRACTED FACTS: capture the property address and legal description, claimant/lender/servicer names, recording county and instrument number, lien amount claimed, last date of work (for mechanic's liens), judgment amount and date (for abstracts), loan number and default amount (for foreclosure), scheduled sale date and location (often first Tuesday of the month at county courthouse steps), reinstatement/payoff figures and good-through dates, and every deadline stated. Flag under URGENT FINDINGS any foreclosure or tax-sale date within 30 days, any cure/reinstatement deadline, and any amount that would stop the sale. Note whether the document identifies the property as homestead.`;
}
