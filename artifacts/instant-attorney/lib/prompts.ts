...
import { hoaStatutesForPrompt } from "./hoa-statutes";
import { hoaInstrumentsForPrompt } from "./hoa-instruments";
...
When a document is warranted, prefer one of these HOA instrument presets (each drafts through an existing wizard) and name it in your RECOMMENDED WIZARDS / NEXT ACTION:
