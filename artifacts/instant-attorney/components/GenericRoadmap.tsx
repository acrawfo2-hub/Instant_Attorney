...
import type { GenericRoadmap as GenericRoadmapData, RoadmapStage } from "@/lib/generic-roadmap";

// ─────────────────────────────────────────────────────────────────────────────
// Generic Roadmap — the Tier-1 fallback shown for any matter without an authored,
// area-specific roadmap. Presentational only; staging is computed by the pure
// lib/generic-roadmap.ts. Mirrors FamilyRoadmap / BankruptcyRoadmap.
// ─────────────────────────────────────────────────────────────────────────────
...
export default function GenericRoadmap({ roadmap }: { roadmap: GenericRoadmapData }) {
  ...
  return (
    <div className="lf-card lf-card-full" style={{ borderLeft: `3px solid ${gold}` }}>
      <div className="lf-card-label">{roadmap.label}</div>
      <p className="lf-wizard-hint" style={{ marginBottom: 16 }}>
        Here&apos;s the path your matter follows and where you are right now. Steps can overlap — use it as a map,
        not a deadline.
      </p>
