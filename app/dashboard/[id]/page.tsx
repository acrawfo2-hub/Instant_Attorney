        ...
        <div className="lf-grid">
          ...
          <div className="lf-card lf-card-full">
            ...
            {recommendedWizards.length > 0 ? (
              <>
                <p className="lf-wizard-hint">Your attorney has suggested the following documents based on your matter.</p>
              ...
              <p className="lf-empty-field">
                Document wizards will appear here once your intake establishes a legal strategy.
              </p>
            )}
          </div>
